...
<br> 1. pandas(Data Preprocessing), 
<br> 2. spacy and nltk (NLP),
<br> 3. openCV (Image Processing), 
<br> 4. sklearn (Traditional ML techniques), 
<br> 5. Tensorflow and Keras (Deep Learning Frameworks) etc
